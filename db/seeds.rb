...
# Jordan 1
  ...
  jordan_1s.each do |sneaker|
    ...
    when "Air Jordan 1 Retro High OG 'Gym Red'"
      main_size_run.each do |size|
        Listing.create({ sneaker_id: sneaker[:id], size: size, price: price_setter(180, 350) })
      end
...
# jordan_1s.each do |sneaker|
#   photo = open("https://ibex-dev.s3-us-west-1.amazonaws.com/ow-aj1.png")
#   photo = open("Users/mohitdhamija/Desktop/ibex-photos/ow-aj1.png")
...
# Concatenates sneaker category arrays into sneakers index array
sneakers = jordan_1s.concat(
  yeezy_350s, 
  yeezy_750s, 
  yeezy_700s, 
  air_yeezys, 
...
sneakers.each do |sneaker|
  ...
  photo = open("https://ibex-pro.s3-us-east-2.amazonaws.com/#{joined_sku}.jpeg") # path interpolate sku.jpeg
  # photo = File.open("Users/mohitdhamija/Desktop/ibex_photos/#{joined_sku}.jpeg") # path interpolate sku.jpeg

  sneaker.photo.attach(
    io: photo, 
    filename: "#{joined_sku}.jpeg" # interpolate sku.jpeg
  )
end